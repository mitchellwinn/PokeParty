...
async def titleGo():
	...
	findByName("titleTrainer").addComponent(Sprite(str(random.randint(1,35))+".png","trainers\\"),"sprite")
...
async def cyclePokemon():
	...
	while game.gameState == "title":
		...
		try:
			...
			return
		findByName("titleTrainer").getNamedComponent("sprite").fileChange(str(random.randint(1,35))+".png")
